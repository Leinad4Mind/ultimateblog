...
class bloglist
{
	...
	*/
	...
	public function archive ($year, $month, $page)
	{
		...
		{
			throw new \phpbb\exception\http_exception(404, $this->lang->lang('BLOG_ERROR_ARCHIVE_EMPTY'));
		}
	...
	public function user($user_id, $page)
	{
		...
		{
			throw new \phpbb\exception\http_exception(404, $this->lang->lang('BLOG_ERROR_NO_USER_BLOG'));
		}
